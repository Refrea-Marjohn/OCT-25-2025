...
<body>
    ...
    <div class="main-content">
        ...
        <div class="quick-actions">
            <a href="admin_usermanagement.php" class="action-card">
            ...
            <a href="admin_managecases.php" class="action-card">
                <div class="action-icon">
                    <i class="fas fa-gavel"></i>
                </div>
                <div class="action-content">
                    <h4>Case Management</h4>
                    <p>Oversee all legal cases and proceedings</p>
                </div>
            </a>
            <a href="admin_documents.php" class="action-card">
                ...
                <div class="action-content">
                    ...
                    <p>Manage all legal documents and files</p>
                </div>
            </a>
            <a href="admin_schedule.php" class="action-card">
                <div class="action-icon">
                    <i class="fas fa-calendar-alt"></i>
                </div>
                <div class="action-content">
                    <h4>Schedule Management</h4>
                    <p>Coordinate appointments and hearings</p>
                </div>
            </a>
            <a href="admin_audit.php" class="action-card">
                <div class="action-icon">
                <i class="fas fa-shield-alt"></i>
                </div>
                <div class="action-content">
                    <h4>Audit Trail</h4>
                    <p>Monitor system activities and security</p>
                </div>
            </a>
            <a href="admin_messages.php" class="action-card">
                ...
                <div class="action-content">
                    <h4>Messages</h4>
                    <p>Communicate with team and clients</p>
                </div>
            </a>
        </div>
    ...
    <style>
        ...
        .stat-card.primary { border-left-color: #5D0E26; }
        .stat-card.success { border-left-color: #27ae60; }
        .stat-card.info { border-left-color: #3498db; }
        .stat-card.warning { border-left-color: #f39c12; }
        .stat-card.secondary { border-left-color: #6c757d; }
        .stat-card.efiling { border-left-color: #7C0F2F; }
        ...
        .stat-card.info .stat-icon { background: linear-gradient(135deg, #3498db, #5dade2); }
        .stat-card.warning .stat-icon { background: linear-gradient(135deg, #f39c12, #f7dc6f); }
        .stat-card.secondary .stat-icon { background: linear-gradient(135deg, #6c757d, #95a5a6); }
