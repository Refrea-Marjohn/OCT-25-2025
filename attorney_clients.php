            ...
            <?php else: foreach ($cases as $case): ?>
                <div class="case-item">
                        ...
                        <div class="case-actions">
                            <button class="btn btn-secondary btn-sm" onclick="openCaseDetailsModal(<?= $case['id'] ?>, '<?= htmlspecialchars($case['title'] ?? '') ?>', '<?= htmlspecialchars($case['client_name'] ?? '') ?>', '<?= htmlspecialchars($case['description'] ?? '') ?>', '<?= htmlspecialchars($case['status'] ?? '') ?>', '<?= htmlspecialchars($case['case_type'] ?? '') ?>', '<?= $case['created_at'] ?>')">
        ...
        document.getElementById('addClientForm').addEventListener('submit', function(e) {
            ...
            .then(data => {
                if (data.success) {
                    ...
                    alert('✅ Client successfully registered! Email sent to ' + data.email);
