        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="jointAffidavitForm" class="modal-form">
                    ...
                    <div class="form-group">
                        <label for="childNameNumber4">Child Name (for #4) <span class="required">*</span></label>
                        <input type="text" id="childNameNumber4" name="childNameNumber4" required placeholder="Enter child's name for item #4">
                    </div>
                ...
                <div id="jointAffidavitDataPreview" class="data-preview">
                    ...
                    <div class="data-preview-content">
                        ...
                        <div class="data-item">
                            <label class="data-label">Child Name (for #4)</label>
