...
if (isset($_POST['edit_id'])) {
    ...
    header('Location: attorney_documents.php?success=Document updated successfully!');
    exit();
}
...
if (isset($_GET['delete']) && is_numeric($_GET['delete'])) {
    ...
    $stmt->bind_param("i", $id);
    $stmt->execute();
    header('Location: attorney_documents.php?success=Document deleted successfully!');
    exit();
}
...
<body>
    ...
    <div class="main-content">
        ...
        <?php if (!empty($success)): ?>
            <div class="alert alert-success" style="margin: 20px; padding: 15px; background: #d4edda; color: #155724; border: 1px solid #c3e6cb; border-radius: 8px; display: flex; align-items: center; gap: 10px;">
        ...
        <div class="upload-section">
            ...
            <form method="POST" enctype="multipart/form-data" id="uploadForm" onsubmit="return handleUploadSubmit(event)">
                ...
                <div style="text-align: center; margin-top: 20px;">
                    <button type="submit" class="btn-primary" id="uploadBtn" style="display: none; background: #1976d2; color: white; border: none; border-radius: 8px; padding: 12px 24px; font-size: 1rem; font-weight: 600; cursor: pointer; box-shadow: 0 2px 8px rgba(25, 118, 210, 0.3); transition: all 0.2s ease;">
            ...
            <?php foreach ($documents as $doc): ?>
                <div class="document-card">
                    ...
                    <div class="document-actions">
                        ...
                        <a href="<?= htmlspecialchars($doc['file_path']) ?>" download class="btn-action btn-view" title="Download Document">
                        ...
                        <a href="?delete=<?= $doc['id'] ?>" onclick="return confirmDelete('<?= htmlspecialchars(pathinfo($doc['file_name'], PATHINFO_FILENAME), ENT_QUOTES) ?>')" class="btn-action btn-delete" title="Delete Document">
            ...
            .then(data => {
                ...
                if (data.includes('Upload Error:')) {
                    ...
                    if (successMatch) {
                        ...
                        fileDataStore.clear();
                        // Auto refresh immediately to show new documents
                        window.location.reload();
                    }
                }
            })
