...
<body>
    ...
    <div class="main-content">
        ...
        <div class="quick-actions-grid">
            <a href="employee_document_generation.php" class="action-card">
                <div class="action-icon">
                    <i class="fas fa-file-alt"></i>
                </div>
                <div class="action-content">
                    <h3>Generate Document</h3>
                    <p>Create legal documents and forms</p>
                </div>
            </a>
            <a href="employee_documents.php" class="action-card">
                <div class="action-icon">
            ...
            <a href="employee_schedule.php" class="action-card">
                <div class="action-icon">
                    <i class="fas fa-calendar-plus"></i>
                </div>
                <div class="action-content">
                    <h3>Manage Schedule</h3>
                    <p>Create and view appointments</p>
                </div>
            </a>
            <a href="employee_clients.php" class="action-card">
                <div class="action-icon">
            ...
            <a href="employee_request_management.php" class="action-card">
                <div class="action-icon">
                    <i class="fas fa-clipboard-check"></i>
                </div>
                <div class="action-content">
                    <h3>Request Review</h3>
                    <p>Review and process requests</p>
                </div>
            </a>
            <a href="employee_messages.php" class="action-card">
                <div class="action-icon">
                    <i class="fas fa-envelope"></i>
                </div>
                <div class="action-content">
                    <h3>Messages</h3>
                    <p>Communicate with team</p>
                </div>
            </a>
        </div>
            ...
            <div class="activity-schedule-grid">
                ...
                <div class="activities-card">
                    <div class="card-header">
                        ...
                        <a href="employee_audit.php" class="view-all-btn">View All</a>
                    </div>
    ...
    <style>
        ...
        .stat-card.primary::before { background: linear-gradient(90deg, #5D0E26, #8B1538); }
        ...
        .stat-card.purple::before { background: linear-gradient(90deg, #6f42c1, #e83e8c); }
