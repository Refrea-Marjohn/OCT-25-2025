    ...
    <div class="user-info" style="display: flex; align-items: center; gap: 20px;">
        ...
        <div class="notifications-container" style="position: relative;">
            <button id="notificationsBtn" style="background: none; border: none; font-size: 20px; color: var(--primary-color); cursor: pointer; padding: 8px; transition: color 0.2s;" onmouseover="this.style.color='var(--accent-color)'" onmouseout="this.style.color='var(--primary-color)'">
                ...
                <span id="notificationBadge" style="position: absolute; top: 0; right: 0; background: #dc3545; color: white; border-radius: 50%; width: 18px; height: 18px; font-size: 10px; display: flex; align-items: center; justify-content: center; font-weight: bold; display: none;">0</span>
            </button>
            
            <!-- Notifications Dropdown -->
            <div id="notificationsDropdown" style="position: absolute; top: 100%; right: 0; background: white; border: 2px solid #8B1538; border-radius: 12px; box-shadow: 0 8px 24px rgba(139, 21, 56, 0.2); width: 350px; max-height: 400px; overflow-y: auto; z-index: 3000; display: none;">
                <div style="padding: 16px; border-bottom: 2px solid #f3f4f6;">
                    <h3 style="margin: 0; font-size: 18px; color: #8B1538; font-weight: 600; display: flex; align-items: center; gap: 8px;">
                        <i class="fas fa-bell" style="color: #8B1538;"></i>
                        Notifications
                        <span id="notificationCount" style="background: #8B1538; color: white; border-radius: 12px; padding: 2px 8px; font-size: 12px; font-weight: bold;">0</span>
                    </h3>
                </div>
