        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="jointAffidavitSoloParentForm" class="modal-form">
                    <div class="form-group">
                        <label for="soloParentJointName">Solo Parent Name <span class="required">*</span></label>
                        <input type="text" id="soloParentJointName" name="soloParentName" required placeholder="Enter solo parent's name">
                    </div>
                    
                    <div class="form-group">
                        <label for="soloParentJointAddress">Solo Parent Address <span class="required">*</span></label>
                        <input type="text" id="soloParentJointAddress" name="soloParentAddress" required placeholder="Enter solo parent's address">
                    </div>
                    
                    <div class="form-group">
                        <label for="firstPersonJointName">First Person Name <span class="required">*</span></label>
                        <input type="text" id="firstPersonJointName" name="firstPersonName" required placeholder="Enter first person's name">
                    </div>
                    
                    <div class="form-group">
                        <label for="firstPersonJointAddress">First Person Address <span class="required">*</span></label>
                        <input type="text" id="firstPersonJointAddress" name="firstPersonAddress" required placeholder="Enter first person's address">
                    </div>
                    
                    <div class="form-group">
                        <label for="secondPersonJointName">Second Person Name <span class="required">*</span></label>
                        <input type="text" id="secondPersonJointName" name="secondPersonName" required placeholder="Enter second person's name">
                    </div>
                    
                    <div class="form-group">
                        <label for="secondPersonJointAddress">Second Person Address <span class="required">*</span></label>
                        <input type="text" id="secondPersonJointAddress" name="secondPersonAddress" required placeholder="Enter second person's address">
                    </div>
                    
                    <div class="form-group">
                        <label for="childJointName">Child Name <span class="required">*</span></label>
                        <input type="text" id="childJointName" name="childName" required placeholder="Enter child's name">
                    </div>
                    
                    <div class="form-group">
                        <label for="fatherJointName">Father Name <span class="required">*</span></label>
                        <input type="text" id="fatherJointName" name="fatherName" required placeholder="Enter father's name">
                    </div>
                    
                    <div class="form-group">
                        <label for="motherJointName">Mother Name <span class="required">*</span></label>
                        <input type="text" id="motherJointName" name="motherName" required placeholder="Enter mother's name">
                    </div>
                    
                    <div class="form-group">
                        <label for="dateOfBirthJoint">Date of Birth <span class="required">*</span></label>
                        <input type="date" id="dateOfBirthJoint" name="dateOfBirth" required>
                    </div>
                    
                    <div class="form-group">
                        <label for="placeOfBirthJoint">Place of Birth <span class="required">*</span></label>
                        <input type="text" id="placeOfBirthJoint" name="placeOfBirth" required placeholder="Enter place of birth">
                    </div>
                    
                    <div class="form-group">
                        <label for="childNameNumber4Joint">Child Name (Number 4) <span class="required">*</span></label>
                        <input type="text" id="childNameNumber4Joint" name="childNameNumber4" required placeholder="Enter child's name for number 4">
                    </div>
                    
                    <div class="form-group">
                        <label for="dateOfNotaryJointSolo">Date of Notary <span class="required">*</span></label>
                        <input type="date" id="dateOfNotaryJointSolo" name="dateOfNotary" required min="<?= date('Y-m-d') ?>">
                    </div>
                ...
                <div id="jointAffidavitSoloParentDataPreview" class="data-preview">
                    ...
                    <div class="data-preview-content">
                        <div class="data-item">
                            ...
                            <div class="data-value" id="previewSoloParentJointName">-</div>
                        </div>
                        <div class="data-item">
                            <label class="data-label">Solo Parent Address</label>
                            <div class="data-value" id="previewSoloParentJointAddress">-</div>
                        </div>
                        <div class="data-item">
                            <label class="data-label">First Person Name</label>
                            <div class="data-value" id="previewFirstPersonJointName">-</div>
                        </div>
                        <div class="data-item">
                            <label class="data-label">First Person Address</label>
                            <div class="data-value" id="previewFirstPersonJointAddress">-</div>
                        </div>
                        <div class="data-item">
                            <label class="data-label">Second Person Name</label>
                            <div class="data-value" id="previewSecondPersonJointName">-</div>
                        </div>
                        <div class="data-item">
                            <label class="data-label">Second Person Address</label>
                            <div class="data-value" id="previewSecondPersonJointAddress">-</div>
                        </div>
                        <div class="data-item">
                            <label class="data-label">Child Name</label>
                            <div class="data-value" id="previewChildJointName">-</div>
                        </div>
                        <div class="data-item">
                            <label class="data-label">Father Name</label>
                            <div class="data-value" id="previewFatherJointName">-</div>
                        </div>
                        <div class="data-item">
                            <label class="data-label">Mother Name</label>
                            <div class="data-value" id="previewMotherJointName">-</div>
                        </div>
                        <div class="data-item">
                            <label class="data-label">Date of Birth</label>
                            <div class="data-value" id="previewDateOfBirthJoint">-</div>
                        </div>
                        <div class="data-item">
                            <label class="data-label">Place of Birth</label>
                            <div class="data-value" id="previewPlaceOfBirthJoint">-</div>
                        </div>
                        <div class="data-item">
                            <label class="data-label">Child Name (Number 4)</label>
                            <div class="data-value" id="previewChildNameNumber4Joint">-</div>
                        </div>
                        <div class="data-item">
                            <label class="data-label">Date of Notary</label>
                            <div class="data-value" id="previewDateOfNotaryJointSolo">-</div>
                        </div>
                    </div>
                    <div class="data-preview-actions">
