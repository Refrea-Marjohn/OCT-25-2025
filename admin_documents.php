...
<body>
                ...
                <div class="filters-grid">
                    ...
                    <div class="filter-group" id="categoryFilter">
                        ...
                        <select name="category" id="categorySelect">
                            ...
                            <option value="Case Files" class="attorney-category" <?= isset($_GET['category']) && $_GET['category'] === 'Case Files' ? 'selected' : '' ?>>Case Files</option>

                            <option value="Court Documents" class="attorney-category" <?= isset($_GET['category']) && $_GET['category'] === 'Court Documents' ? 'selected' : '' ?>>Court Documents</option>

                            <option value="Client Documents" class="attorney-category" <?= isset($_GET['category']) && $_GET['category'] === 'Client Documents' ? 'selected' : '' ?>>Client Documents</option>

                            <!-- Employee Categories -->

                            <option value="Notarized Documents" class="employee-category" <?= isset($_GET['category']) && $_GET['category'] === 'Notarized Documents' ? 'selected' : '' ?>>Notarized Documents</option>

                            <option value="Law Office Files" class="employee-category" <?= isset($_GET['category']) && $_GET['category'] === 'Law Office Files' ? 'selected' : '' ?>>Law Office Files</option>
    ...
    <script>
            ...
            downloadItems.forEach(item => {
                ...
                switch(filter) {
                    ...
                    case 'yesterday':
                        ...
                        showItem = itemDate.toDateString() === yesterday.toDateString();
        ...
        function updateDocumentCount() {
            ...
            const visibleItems = document.querySelectorAll('.download-item[style*="block"], .download-item:not([style*="none"])');
