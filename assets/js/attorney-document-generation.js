...
function viewJointAffidavitSoloParentData() {
    document.getElementById('previewSoloParentJointName').textContent = jointAffidavitSoloParentData.soloParentName || '-';
    document.getElementById('previewSoloParentJointAddress').textContent = jointAffidavitSoloParentData.soloParentAddress || '-';
    document.getElementById('previewFirstPersonJointName').textContent = jointAffidavitSoloParentData.firstPersonName || '-';
    document.getElementById('previewFirstPersonJointAddress').textContent = jointAffidavitSoloParentData.firstPersonAddress || '-';
    document.getElementById('previewSecondPersonJointName').textContent = jointAffidavitSoloParentData.secondPersonName || '-';
    document.getElementById('previewSecondPersonJointAddress').textContent = jointAffidavitSoloParentData.secondPersonAddress || '-';
    document.getElementById('previewChildJointName').textContent = jointAffidavitSoloParentData.childName || '-';
    document.getElementById('previewFatherJointName').textContent = jointAffidavitSoloParentData.fatherName || '-';
    document.getElementById('previewMotherJointName').textContent = jointAffidavitSoloParentData.motherName || '-';
    document.getElementById('previewDateOfBirthJoint').textContent = jointAffidavitSoloParentData.dateOfBirth || '-';
    document.getElementById('previewPlaceOfBirthJoint').textContent = jointAffidavitSoloParentData.placeOfBirth || '-';
    document.getElementById('previewChildNameNumber4Joint').textContent = jointAffidavitSoloParentData.childNameNumber4 || '-';
    document.getElementById('previewDateOfNotaryJointSolo').textContent = jointAffidavitSoloParentData.dateOfNotary || '-';
}
...
function editJointAffidavitSoloParentData() {
    ...
    // Populate form with saved data
    document.getElementById('soloParentJointName').value = jointAffidavitSoloParentData.soloParentName || '';
    document.getElementById('soloParentJointAddress').value = jointAffidavitSoloParentData.soloParentAddress || '';
    document.getElementById('firstPersonJointName').value = jointAffidavitSoloParentData.firstPersonName || '';
    document.getElementById('firstPersonJointAddress').value = jointAffidavitSoloParentData.firstPersonAddress || '';
    document.getElementById('secondPersonJointName').value = jointAffidavitSoloParentData.secondPersonName || '';
    document.getElementById('secondPersonJointAddress').value = jointAffidavitSoloParentData.secondPersonAddress || '';
    document.getElementById('childJointName').value = jointAffidavitSoloParentData.childName || '';
    document.getElementById('fatherJointName').value = jointAffidavitSoloParentData.fatherName || '';
    document.getElementById('motherJointName').value = jointAffidavitSoloParentData.motherName || '';
    document.getElementById('dateOfBirthJoint').value = jointAffidavitSoloParentData.dateOfBirth || '';
    document.getElementById('placeOfBirthJoint').value = jointAffidavitSoloParentData.placeOfBirth || '';
    document.getElementById('childNameNumber4Joint').value = jointAffidavitSoloParentData.childNameNumber4 || '';
    document.getElementById('dateOfNotaryJointSolo').value = jointAffidavitSoloParentData.dateOfNotary || '';
}
...
function generateJointAffidavitSoloParentPDF() {
    ...
    // Validate required fields
    if (!data.soloParentName || !data.soloParentAddress || !data.firstPersonName || 
        !data.firstPersonAddress || !data.secondPersonName || !data.secondPersonAddress || 
        !data.childName || !data.fatherName || !data.motherName || !data.dateOfBirth || 
        !data.placeOfBirth || !data.childNameNumber4 || !data.dateOfNotary) {
        alert('Please fill in all required fields before generating PDF.');
        return;
    }
